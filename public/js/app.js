...
/* harmony import */ var _functions_validator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./functions/validator */ "./resources/js/functions/validator.js");
...
/* WEBPACK VAR INJECTION */(function($) {var menuItems = document.querySelectorAll('.menu_wrapper-item-main_menu-item');
var secondary = $('.menu_wrapper-item-main_menu-item-text_secondary');
var menu = document.querySelector('.menu_wrapper-item-main_menu');
var dropdown = document.querySelector('.menu_wrapper-item_menuText');
var array = [document.querySelector('.menu_wrapper-item-main_menu-item-text_secondary'), secondary, menu, dropdown];
var search = document.querySelector('.menu_wrapper-item_search');
$(document).ready(function () {
  var state = false;
  ...
  $('.menu_wrapper-item_hamburger').on('click', function () {
...
window.onload = function () {
  if (typeof Swiper !== 'undefined') {
    var main = new Swiper('.landswiper', {
      slidesPerView: 'auto',
...
var LandingController = /*#__PURE__*/function () {
  ...
  _createClass(LandingController, [{
    ...
    value: function _priceController(val, el) {
      var values = el.querySelectorAll('.economslider_value');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _functions_validator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../functions/validator */ "./resources/js/functions/validator.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var Validator = function Validator() {
  ...
  window.app.validator = {
     ...
     * @param config
     */
    validate: function validate(data, config) {
      var result = true;
    ...
    valid: function valid(rules, data) {
      var result = true;
      app.validator.parseMessage();
    ...
    parseRules: function parseRules(rulesStr) {
    ...
    parseRule: function parseRule(rule) {
      var _rule, _val;
    ...
    validateFunction: {
      ...
      phone: function phone(val) {
        var checkedString = val.replace(/[- )(]/g, ''),
      ...
      valid: function valid(val, dataVal) {
        return dataVal;
      },
      checked: function checked(val, dataVal, el) {
        return $(el).prop('checked');
      },
      orRequired: function orRequired(val, dataVal, el) {
        var result = app.validator.validateFunction.required(val, dataVal, el);
        var item;

        if (!result) {
          item = _.findWhere(app.validator.validArray, {
            name: dataVal
          });
    ...
    invalidTextFunction: {
      ...
      orRequired: function orRequired(value, ruleVal, elem) {
    ...
    formValidate: function formValidate(array, $form, silent) {
      var that = this,
          allValid = true;
      app.validator.parseMessage();
      that.validArray = [];
      ...
      _.each(that.validArray, function (el) {
        ...
        _.each(el.rules, function (ruleVal, ruleName) {
          var $parent = el.elem.parents(that.config.selectorFieldItem);
          var text;
    ...
    inputValidate: function inputValidate($input) {
      var that = this,
          valid = true;
      app.validator.parseMessage();
      this.validArray = [];
