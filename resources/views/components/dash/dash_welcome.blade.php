<div class="dash_right-wrap">
    ...
    <div class="dash_right_profit">
        <div class="dash_right_profit-item" style="background-image: url('./images/dash/dash_profit.svg')"></div>
        <div class="dash_right_profit-item" style="background-image: url('./images/dash/dash_profit2.svg')"></div>
    </div>
</div>
