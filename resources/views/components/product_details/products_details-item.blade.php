    ...
    <div class="details_wrap">
        ...
        <div class="details_wrap-slider">
                ...
                <div class="swiper-wrapper">
                    @forelse($product['images'] as $img)
                            <div class="swiper-slide details_slide"
                                 style="background-image:url({{ Storage::url('product_images/' . $img->image) }})"></div>
                        @empty
                            <div class="swiper-slide details_slide"
            ...
            <div class="swiper-container gallery-thumbs">
                <div class="swiper-wrapper">
                    @forelse($product['images'] as $img)
                        <div class="swiper-slide details_slide details_slide_thumb"
                             style="background-image:url({{ Storage::url('product_images/' . $img->image) }})"></div>
                            @empty
                            <div class="swiper-slide details_slide"
                                 style="background-image:url('/images/unnecessary/owl-swiper.svg')"></div>
        ...
        <div class="details_wrap-info">
            ...
            <div class="details_wrap-info_item">
                <div class="details_wrap-info_item-desc">
                    ...
                    <p>@if(isset($params->color)) {{ $params->color }}  @endif тонер-картридж TC-H85A для принтеров и
                        МФУ:</p>
                </div>
            </div>
            ...
            <div class="details_wrap-info_item">
                <div class="details_wrap-info_item-icons">
                    ...
                    @if($params->color == 'Трехцветный')
                        <div class="details_wrap-info_item-icons_icon"
                    ...
                    @elseif($params->color == 'Желтый')
                        <svg class="details_wrap-info_item-icons_icon" width="50" height="50" viewBox="0 0 50 50"
            ...
            <div class="details_wrap-info_item price_wrap">
                <div class="details_wrap-info_item-price">
                    ...
                    <div class="details_wrap-info_item-price_item">
                        <span
                            class="details_wrap-info_item-price_item-price"><? echo floor($product['price']); ?></span>
