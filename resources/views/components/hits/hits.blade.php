...
<div class="hits_recs">
    ...
    <div class="hits_recs-item">
        <div class="hits_recs-item_inner hits_recs-row">
            <div class="hits_recs-item_inner-item">
                <span>домой</span>
            </div>
            <div class="hits_recs-item_inner-item">
                <span>в офис</span>
        ...
        <div class="hits_recs-item_inner hits_recs-row second-hits_recs-row">
            <div class="hits_recs-item_inner-item">
...
<div class="hits-items">
    <div class="hits-items_column">
        <div class="hits-items_column-item">
            ...
            <div class="hits-items_column-item-heading-strong">
                выбор
            </div>
        </div>
        ...
        <div class="hits-items_column-item">
                    <span class="hits-items_column-item-text">
                        Цветность печати
                    </span>
        </div>
    ...
    <div class="hits-items_column">
        <div class="hits-items_column-item">
            <div class="hits-items_column-item-heading-small">
                Лазерный для презентаций
            </div>
            <div class="hits-items_column-item-heading-big">
        ...
        <div class="hits-items_column-item">
            <div class="hits-items_column-item-image">
                <img src='/images/hits/hits_printer.svg' alt="Hits"/>
            </div>
        </div>
    ...
    <div class="hits-items_column">
        ...
        <div class="hits-items_column-item">
            <div class="hits-items_column-item-image">
                <img src='/images/hits/hits_printer2.svg' alt="Hits" />
            </div>
        </div>
