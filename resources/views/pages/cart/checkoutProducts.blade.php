            ...
            <div class="cart_check-wrap" data-href="{{ route('setCustomerFio') }}">
                ...
                <div class="cart_check-wrap_item">
                    ...
                    <div class="cart_check-wrap_item-group">
                        ...
                        <label for="required" class="invisible">Поле фамилия обязательно к заполнению</label>
                    </div>
                </div>
                ...
                <div class="cart_check-wrap_item">
                    <div class="cart_check-wrap_item-group">
                        ...
                        <label for="required" class="invisible">Поле телефон обязательно к заполнению</label>
                    </div>
