...
//Main page
Route::get('/', ['uses' => "ProductsController@showIndex", 'as' => 'mainPage']);
...
Route::post('/StoreNewPasswordEmail', ['uses' => 'ChangePasswordController@storeFromEmail', 'as' => 'StoreNewPasswordEmail']);
